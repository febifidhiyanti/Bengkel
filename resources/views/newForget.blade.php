			...
			<div class="card-box">
						...
						<div class="form-group m-b-0">
							<div class="input-group">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
									...
									<button type="submit"  style="background-color: #5fbeaa; color: white;"class="btn w-sm waves-effect waves-light">
										Reset 
									</button> 
								</span>
							</div>
                ...
                <div class="row">
                            <div class="col-sm-12 text-center">
                                <p></p>    
                                <p>Apakah belum memiliki akun? <a href="/register"  style="color: #5fbeaa;" class="m-l-5"><b>Daftar</b></a>
                                <br>Apakah memiliki akun?<a href="/login"  style="color: #5fbeaa;" class="m-l-5"><b>Masuk</b></a></p>
                            </div>
                        </div>
